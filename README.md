![docker image](https://github.com/GinzburgLev/test-oasis-for-workshop/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/GinzburgLev/test-oasis-for-workshop.git
    ...
    ```sh
    curl-L -o test-oasis-for-workshop.zip "https://github.com/GinzburgLev/test-oasis-for-workshop/archive/main.zip"
    unzip test-oasis-for-workshop.zip
    cd test-oasis-for-workshop
    ```
...
your `docker-compose.yaml` with `ghcr.io/ginzburglev/test-oasis-for-workshop:main` for the services
...
```sh
docker pull ghcr.io/ginzburglev/test-oasis-for-workshop/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/GinzburgLev/test-oasis-for-workshop/manifests/main": unauthorized`
